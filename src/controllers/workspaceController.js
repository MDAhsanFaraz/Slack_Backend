...
export const getWorkspacesUserIsMemberOfController = async (req, res) => {
  try {
    ...
    console.log(
      'workspaceController getWorkspacesUserIsMemberOfController error',
      error
    );
    if (error.statusCode) {
      return res.status(error.statusCode).json(customErrorResponse(error));
...
export const deleteWorkspaceController = async (req, res) => {
  try {
    ...
    console.log('workspaceController deleteWorkspaceController error', error);
    if (error.statusCode) {
      return res.status(error.statusCode).json(customErrorResponse(error));
    }
...
export const getWorkspaceController = async (req, res) => {
  try {
    ...
    console.log('workspaceController getWorkspaceController error', error);
    if (error.statusCode) {
      return res.status(error.statusCode).json(customErrorResponse(error));
    }
    return res
...
export const getWorkspaceByJoinCodeController = async (req, res) => {
  try {
    const response = await getWorkspaceJoinCodeService(
      req.params.joinCode,
      req.user
    );
    return res
    ...
    console.log(
      'workspaceController getWorkspaceByJoinCodeController error',
      error
    );
    if (error.statusCode) {
      return res.status(error.statusCode).json(customErrorResponse(error));
...
export const updateWorkspaceController = async (req, res) => {
  try {
    ...
    console.log('workspaceController updateWorkspaceController error', error);
    if (error.statusCode) {
      return res.status(error.statusCode).json(customErrorResponse(error));
    }
    return res
...
export const addMemberToWorkspaceController = async (req, res) => {
  try {
    ...
    console.log(
      'workspaceController addMemberToWorkspaceController error',
      error
    );
    if (error.statusCode) {
      return res.status(error.statusCode).json(customErrorResponse(error));
...
export const addChannelToWorkspaceController = async (req, res) => {
  try {
    ...
    console.log(
      'workspaceController addChannelToWorkspaceController error',
      error
    );
    if (error.statusCode) {
      return res.status(error.statusCode).json(customErrorResponse(error));
